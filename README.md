...
- Обратите вниамние на производительность вашего решения.
- Решение должны быть компактным.
- Решение должно быт простым, умещаться в 1м файле и содержать не более 20 строк кода.
...
- Обратите вниамние на производительность вашего решения.
- Решение должны быть компактным.
- Решение должно быт простым, умещаться в 1м файле и содержать 20-30 строк кода или меньше.
...
## Задача №2
Есть 3 двери и 2 монеты.
С помощью 2х монет нужно **равновероятностно**(!) выбрать одну из дверей.
Для выбора нужно обязательно задействовать 2 монеты.

Реализуйте ваш алгоритм в виде кода.
